...
function page(content: string) {
  content = `<nav aria-label="Main navigation" style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:1.5rem;padding-bottom:1rem;border-bottom:1px solid #e9e0d4"><a href="/app">Archive</a><a href="/drive/folders">Photo folders</a><a href="/people">People &amp; family</a></nav>${content}`;
